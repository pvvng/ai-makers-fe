...
export default function CarouselCard({ cardData }: { cardData: CarouselData }) {
  ...
  return (
    <div className="w-1/4 px-1">
      <div className="bg-white relative p-2 px-4 border rounded-2xl w-full h-[230px] shadow hover:shadow-md flex justify-start items-center transition-all cursor-pointer">
